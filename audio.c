...
static char *MUSIC_THEME[2][4] = {
  { "flobopuyo_menu.ogg", "flobopuyo_game1.ogg", "flobopuyo_game2.ogg", "flobopuyo_gameover.ogg" },
  { "flobopuyo_menu.ogg", "strange_fear.ogg", "strange_fear2.ogg", "strange_gameover.ogg" }
};
