...
enum MAP_KEY
{
  ...
  if (e.type == SDL_JOYBUTTONDOWN){
    ...
    if (e.jbutton.button==VK_VOL_UP ){
       music_volume+=10;
       if (music_volume>100)music_volume=100;
       audio_music_set_volume (music_volume);
       audio_set_volume (music_volume*3/2);
    }

    if (e.jbutton.button==VK_VOL_DOWN ){
       music_volume-=10;
