...
void PuyoStarter::draw()
{
    if (stopRendering) {
        ...
        {
            drect.x = 160 - perso[currentPerso]->w/2;
            drect.y = 140 - perso[currentPerso]->h/2;
    ...
    SoFont_CenteredString_XY (font, display, 255, 230,   p1name, NULL);
    SoFont_CenteredString_XY (font, display, 65, 230,   p2name, NULL);
    ...
    SDL_Rect drect;
    drect.x = 160 - speedRect.w / 2;
    drect.y = 85 - speedRect.h;
    drect.w = speedRect.w;
    drect.h = speedRect.h;
