...
{
      17,     0,    -1,    18,    20,    19,    -1,    -1,    -1,    20,
      21,    -1,    -1,     7,     4,    -1,     5,     4,    -1,     6,
       3,    14,     3,    -1,     9,     3,    10,    -1,    11,    -1,
      12,     3,    14,     3,    14,     3,    14,     3,    14,     3,
      -1,    13,    -1,    15,     4,    -1
};
...
{
       0,   135,   135,   137,   145,   150,   151,   154,   158,   162,
     166,   169,   172,   179,   182
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "STRING", "BACKGROUND",
  "VECTOR", "FOREGROUND", "MUSIC", "WAIT", "SEC", "LOOP", "TEXTAREA",
  "NOTEXTAREA", "COMMA", "SAY", "$accept", "scenar", "prologue",
  "epilogue", "instructions", "instruction", 0
};
#endif
...
{
       3,     0,     6,     1,     4,     0,     0,     0,     0,    11,
       0,    13,     0,     2,     5,     8,     0,     7,     0,     0,
      14,     0,    10,     0,     9,     0,     0,     0,     0,     0,
       0,    12
};
...
{
      -6,     3,    -6,    -6,    -5,     1,     6,     7,     9,    -6,
      10,    -6,    11,    -6,    -6,    -6,     0,    -6,     8,     2,
      -6,    14,    -6,    16,    -6,    12,    17,    13,    18,    15,
      19,    -6
};
...
{
       5,     6,     7,     3,     8,    15,     9,    10,    11,    16,
      12,    17,    18,    19,    21,    20,    23,    24,    22,    25,
      27,    29,    31,     0,     0,     0,    26,    28,     0,    30
};

static const yysigned_char yycheck[] =
{
       5,     6,     7,     0,     9,     4,    11,    12,    13,     3,
      15,     4,     3,     3,    14,     4,    14,     3,    10,     3,
       3,     3,     3,    -1,    -1,    -1,    14,    14,    -1,    14
};
...
{
       0,    17,    18,     0,    20,     5,     6,     7,     9,    11,
      12,    13,    15,    19,    21,     4,     3,     4,     3,     3,
       4,    14,    10,    14,     3,     3,    14,     3,    14,     3,
      14,     3
};
...
#line 154 "scenar.y"
    {
          if(first_layer) { IIM_Free(first_layer); first_layer=0; }
          first_layer = IIM_Load_DisplayFormatAlpha(yyvsp[0].str);
        }
    break;
...
#line 158 "scenar.y"
    {
          if(back_layer)  { IIM_Free(back_layer);  back_layer=0;  }
          back_layer = IIM_Load_DisplayFormatAlpha(yyvsp[0].str);
        }
    break;
...
#line 162 "scenar.y"
    {
          dec_vectorx = 0.01f * yyvsp[-2].i;
          dec_vectory = 0.01f * yyvsp[0].i;
        }
    break;
